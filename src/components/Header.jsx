...
const Header = ({ onOpenMenu, onOpenAnalytics, onGoHome }) => {
    return (
        <header className="px-4 md:px-8 h-14 md:h-16 flex items-center justify-between bg-[#070c14]/95 backdrop-blur-xl border-b border-white/[0.06] sticky top-0 z-[1000]">
            ...
            >
                <div className="w-8 h-8 md:w-10 md:h-10 bg-white rounded-lg flex items-center justify-center overflow-hidden shrink-0 shadow-md group-hover:shadow-[0_0_18px_rgba(0,207,191,0.35)] transition-shadow duration-300">
                ...
                <div className="flex flex-col items-start leading-none">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[#00cfbf] text-[15px] md:text-[20px] font-black uppercase tracking-tight">Spatial</span>
                    </div>
            ...
            <div className="flex items-center gap-1 md:gap-1.5">
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 px-3 md:px-4 h-8 md:h-9 rounded-lg bg-[#00cfbf]/10 hover:bg-[#00cfbf]/20 text-[#00cfbf] border border-[#00cfbf]/20 hover:border-[#00cfbf]/40 transition-all"
                >
